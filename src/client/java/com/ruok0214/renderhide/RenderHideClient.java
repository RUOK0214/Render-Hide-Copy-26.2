...
implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        LOGGER.info("Render Hide {} initialized by RUOK0214",
                net.fabricmc.loader.api.FabricLoader.getInstance().getModContainer("renderhide")
